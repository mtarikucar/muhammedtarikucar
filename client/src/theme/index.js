 ...
 * This file contains the theme settings for Material Tailwind
 */
...
// Define the theme border radius
...
// Define the theme for Material Tailwind
const materialTailwindTheme = {
  colors: {
    blue: themeColors.primary,
    'blue-gray': themeColors.secondary,
