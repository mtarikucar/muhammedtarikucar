...
const AudioPlayer = ({ src, homepage }) => {
  ...
  return (
    <div className={`flex flex-col items-center p-5 roundedLg ${!homepage && "border-2 my-2 w-full bg-gray-200"}`}>
      <audio
        ref={audioRef}
        src={src}
      ...
      >
        {playing ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
