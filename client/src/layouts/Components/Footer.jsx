      ...
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          {footerLinks.map(({ title, items }) => (
            <div key={title} className="col-span-1">
              <Typography variant="small" className="mb-3 font-medium opacity-60">
                {title}
              </Typography>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-gray-200 py-4 md:flex-row md:justify-between">
          ...
          <div className="flex gap-4 text-gray-600 sm:justify-center">
            ...
            <a href="https://github.com/mtarikucar" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition-opacity">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://linkedin.com/in/muhammedtarikucar" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition-opacity">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
